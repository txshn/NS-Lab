...
main (int argc, char *argv[])
{
  ...
  //Vector pos1(100,100,0);
  mob1->SetPosition(Vector(100,100,0));
  mob1->SetVelocity(Vector(-25,-25,0));

  Ptr<ConstantVelocityMobilityModel> mob2 = wifiStaNodes.Get(1)->GetObject<ConstantVelocityMobilityModel>();
  mob2->SetPosition(Vector(-100,-100,0));
  mob2->SetVelocity(Vector(25,25,0));

  Ptr<ConstantVelocityMobilityModel> mob3 = wifiStaNodes.Get(2)->GetObject<ConstantVelocityMobilityModel>();
  mob3->SetPosition(Vector(-100,100,0));
  mob3->SetVelocity(Vector(25,-25,0));

  Ptr<ConstantVelocityMobilityModel> mob4 = wifiStaNodes.Get(4)->GetObject<ConstantVelocityMobilityModel>();
  mob4->SetPosition(Vector(100,-100,0));
  mob4->SetVelocity(Vector(-25,25,0));
  ...
  anim.SetConstantPosition(wifiStaNodes.Get(1),10.0,10.0);
  anim.SetConstantPosition(wifiStaNodes.Get(2),20.0,20.0);
  anim.SetConstantPosition(wifiStaNodes.Get(3),30.0,30.0);
